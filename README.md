...
> من مریم هستم، یک برنامه‌نویس مشتاق با تمرکز بر ساخت سیستم‌های هوشمند بک‌اند.

🎀 **تحصیلات:** دانشجوی سال آخر مهندسی کامپیوتر در **دانشگاه صنعتی نوشیروانی بابل**. <br>
✨ **کارآموزی:** توسعه‌دهنده نرم‌افزار در شرکت **جادوی فکر** (ساری). <br>
🧠 **تمرکز:** توسعه بک‌اند و ساخت سیستم‌های هوشمند با تکیه بر LLM و RAG. <br>
📜 **گواهی‌نامه:** فارغ‌التحصیل **دوره پیشرفته LLM**.
...
*(این بخش به زودی با پروژه‌های LLM و بک‌اند تکمیل خواهد شد!)*
